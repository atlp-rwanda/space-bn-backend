export const template = (firstname, token) => {
    return `
    <style type="text/css">
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        ...
        <div style="font-family: inherit; text-align: center"><span style="color: #000000; font-size: 30px">Barefoot Nomad.</span></div>
        </td>
      </tr>
    </tbody>
...
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 18px">2. Get access to our Barefoot Nomad system for hotels in rwanda.</span></div>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="6E6E6E">
                                            ...
                                            <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">Barefoot Nomad project</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">KG 345 street</span>, <span class="Unsubscribe--senderCity">Rwanda</span>, <span class="Unsubscribe--senderState">Kigali City</span> <span class="Unsubscribe--senderZip">+250</span></p></div>
